...
# #Lena's plot
# ggplot (monod_rfu, aes (x = treatment, y = mumax))+
#   geom_point (size = 5, alpha = 0.6)+
#   #scale_y_continuous(breaks = seq(0, 0.4, 0.05))+
#   ylab ("Growth rate (d-1)")+
#   xlab ("Treatment")+
#   scale_x_discrete(limits = c("noMnnoFe", "noMn", "noFe", "replete"))+
...
photophys_fe_fvfm_vs_sigma_2 <- photophys_fe_fvfm_vs_sigma [-c(1:16),]
...
#an alternative to anova , a non-parametric test would be the kruskal test
kruskal.test(RCII~Temperature, photophys_fe)
...
x<- aov(RCII~FeEDTA, photophys_fe)
summary(x)
